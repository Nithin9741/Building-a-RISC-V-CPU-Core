...
\TLV
   ...
   // Instruction Memory, implemented using macro
   ...
   */
   ...
   //`BOGUS_USE ( $rs1_valid $rs2_valid $imm_valid $rd_valid $funct3_valid $funct7_valid )
   
   // extracting immediate bits
   ...
   // Decode Logic: Instruction decoding
   ...
   $br_tgt_pc[31:0]   =  $pc[31:0] + $imm;   // JAL = Jump and link
   $jalr_tgt_pc[31:0] = $src1_value + $imm;  // JALR = Jump and link register
   //--------------------------------------------------------------------------------------------------------------
